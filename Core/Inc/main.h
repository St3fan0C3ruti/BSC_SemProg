...
#define FRENO_SENSE_Pin GPIO_PIN_3
#define FRENO_SENSE_GPIO_Port GPIOA
#define SPEED_SENSE_Pin GPIO_PIN_4
#define SPEED_SENSE_GPIO_Port GPIOA
#define HALLA_Pin GPIO_PIN_5
#define HALLA_GPIO_Port GPIOA
#define SensorePedale_Pin GPIO_PIN_6
#define SensorePedale_GPIO_Port GPIOA
